...
export const backgroundBody="#0B0B0B";
export const colorTextoInput= '#C2C2C2'


export const fuente__Principal="'Roboto', sans-serif";
export const fuente__New="'Source Sans Pro', sans-serif";